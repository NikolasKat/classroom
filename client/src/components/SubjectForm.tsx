...
const SubjectForm = () => {
    ...
    return (
        <form
            ...
            className="p-5 bg-slate-100 absolute right-6 top-36 rounded-xl w-2/6 z-10 shadow-2xl shadow-slate-500/50 border border-solid"
        >
            <div className="relative z-0 w-full mb-5 group">
                ...
                <label
                    ...
                    className="peer-focus:font-medium absolute text-md text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-4 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                    Subject name
                </label>
